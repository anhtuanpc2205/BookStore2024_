...
CREATE TABLE tbl_User(
    ...
    user_address NVARCHAR(255), -- Địa chỉ giao hàng của người dùng
...
CREATE TABLE tbl_Order(
    ...
    shipping_address NVARCHAR(255), -- Địa chỉ giao hàng của
...
UPDATE tbl_Blog SET views_= 30 WHERE blog_id < 5
UPDATE tbl_Blog SET views_= 12 WHERE blog_id > 5 AND blog_id < 10
